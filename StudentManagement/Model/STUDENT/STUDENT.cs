...
namespace StudentManagement.Model.STUDENT
{
    public class STUDENT : BaseViewModel
    {
        ...
        private string _lop_hien_tai;
        public string lop_hien_tai { get => _lop_hien_tai; set { _lop_hien_tai = value; OnPropertyChanged(); } }
        ...
        public void AddNewStudent(string ten_hoc_sinh, string gioi_tinh, string ngay_sinh, string dan_toc, string quoc_tich, string ton_giao, string ho_ten_cha, string ho_ten_me, string sdt_hoc_sinh, string sdt_phu_huynh, string dia_chi, string avatar)
        {
        ...
        public void EditStudent(int ma_hoc_sinh, string ten_hoc_sinh, string gioi_tinh, string ngay_sinh, string dan_toc, string quoc_tich, string ton_giao, string ho_ten_cha, string ho_ten_me, string sdt_hoc_sinh, string sdt_phu_huynh, string dia_chi, string avatar)
        {
